...
try:
    ...
    st.error(f"Unable to load model. Check the specified path: {model_path}", icon="🚨")
    st.error(ex)
...
if source_radio == settings.IMAGE:
    ...
    with col1:
        try:
            ...
            st.error("Error occurred while opening the image.", icon="🚨")
            st.error(ex)
    ...
    with col2:
            if st.sidebar.button('Detect Objects'):
                try:
                    ...
                    st.error("Please select a valid source type!", icon="🚨")
                ...
                try:
                    ...
                    st.write("No image is uploaded yet!", icon="🚨")
